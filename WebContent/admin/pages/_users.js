...
var _pagescript = {
		...
		init: function() {
			...
			if(components) {
				components.jqxGrid({
					...
					columns: [
			          ...
			          { text: 'Job Position', datafield: 'jobPosition', width: '10%', align: 'center' },
			          ...
			          { text: 'Status', datafield: 'status', width: '9%', align: 'center' }
			        ]
				});
				...
				components.on("rowselect", function (event) {
					...
					$("#user-group").val((event.args.row.jobPosition !== undefined && event.args.row.jobPosition)? event.args.row.jobPosition : "");
					...
					WRPAdminApp.pagescript.getPermissionSet();
					WRPAdminApp.pagescript._selectedUserSid = event.args.row.sid;
			...
			if (components) {
				components.jqxGrid({
					...
					columns: [
								...
								{ text: 'Assign', datafield: 'Assign', width: '5%', align: 'center', columntype: 'checkbox', editable: true, type:'bool'}
					         ]
				});
			}
			

	    	components = $("#users-sales-permission-setting");
	    	if (components) {
	    		components.jqxGrid({
	    			width: "99%",
	    			height: "100%",
	    	        ...
	    	        selectionmode: 'none',
	    			columns: [
	 				   { text: "Name", datafield: "page_name", width: "40%", editable: false, align: 'center' },
	    		...
	    		components.on('cellvaluechanged', function (event) {
				    ...
				    if(datafield == "all"){
				    	if(value == true){
				    		$("#users-sales-permission-setting").jqxGrid('setcellvalue', rowBoundIndex, "view", true);
				    		$("#users-sales-permission-setting").jqxGrid('setcellvalue', rowBoundIndex, "add", true);
				    		$("#users-sales-permission-setting").jqxGrid('setcellvalue', rowBoundIndex, "edit", true);
				    	}else{
				    		$("#users-sales-permission-setting").jqxGrid('setcellvalue', rowBoundIndex, "view", false);
				    		$("#users-sales-permission-setting").jqxGrid('setcellvalue', rowBoundIndex, "add", false);
				    		$("#users-sales-permission-setting").jqxGrid('setcellvalue', rowBoundIndex, "edit", false);
				    	}
				    }else{
				    	return;
				    }
	    	...
	    	components = $("#users-backend-permission-setting");
	    	if (components) {
	    		components.jqxGrid({
	    			width: "99%",
	    			height: "100%",
	    		...
	    		components.on('cellvaluechanged', function (event) {
				    ...
				    if(datafield == "all"){
				    	if(value == true){
				    		$("#users-backend-permission-setting").jqxGrid('setcellvalue', rowBoundIndex, "view", true);
				    		$("#users-backend-permission-setting").jqxGrid('setcellvalue', rowBoundIndex, "add", true);
				    		$("#users-backend-permission-setting").jqxGrid('setcellvalue', rowBoundIndex, "edit", true);
				    	}else{
				    		$("#users-backend-permission-setting").jqxGrid('setcellvalue', rowBoundIndex, "view", false);
				    		$("#users-backend-permission-setting").jqxGrid('setcellvalue', rowBoundIndex, "add", false);
				    		$("#users-backend-permission-setting").jqxGrid('setcellvalue', rowBoundIndex, "edit", false);
				    	}
				    }else{
				    	return;
				    }
			...
			$.ajax({
				...
				success: function(result) {
					...
					for (var i = 0; i < result.data.length; i++) {
						data[i].zipcode = (data[i].zipcode !== undefined && data[i].zipcode)? data[i].zipcode : "";
						data[i].address2 = (data[i].address2 !== undefined && data[i].address2)? data[i].address2 : "";
						data[i].address1 = (data[i].address1 !== undefined && data[i].address1)? data[i].address1 : "";
						data[i].city = (data[i].city !== undefined && data[i].city)? data[i].city : "";
						data[i].state = (data[i].state !== undefined && data[i].state)? data[i].state : "";
						
						data[i].Address = data[i].zipcode+" "+data[i].address2+" "+data[i].address1+" "+data[i].city+" "+data[i].state;
						data[i].Assign = false;
					}
		...
		getPermissionGroupList: function() {
			$.ajax({
				...
				success: function(result) {
					...
					try {
						document.getElementById("user-edit-permission-group").innerHTML = innerHTML.join("");
						document.getElementById("user-add-permission-group").innerHTML = innerHTML.join("");
					} catch (e) {
	    ...
	    getPermissionSet: function(){
	    	...
	    	data = [
	    		{page_name:"dashboard", all:false, view:1, add:false, edit:false},
	    		{page_name:"dashboard", all:false, view:1, add:false, edit:false},
	    		{page_name:"dashboard", all:false, view:2, add:false, edit:false},
	    		{page_name:"dashboard", all:false, view:false, add:false, edit:false},
	    		{page_name:"dashboard", all:false, view:false, add:false, edit:false},
	    		{page_name:"dashboard", all:false, view:false, add:false, edit:false},
	    		{page_name:"dashboard", all:false, view:false, add:false, edit:false},
	    	];
	    	elem = $("#users-sales-permission-setting");
			if (elem) {
				elem.jqxGrid("clear");
				elem.jqxGrid("addRow", null, data, "last");		
			}
			
			elem = $("#users-backend-permission-setting");
			if (elem) {
				elem.jqxGrid("clear");
				elem.jqxGrid("addRow", null, data, "last");		
			}
					...
					if(elem){
						...
						if(rowscount != 0){
							for (i = 0; i < rowscount ; i++) {
								elem.jqxGrid('setcellvalue', i, "Assign", false);
		...
		informSelectedUserData: function() {
			...
			$.ajax({
				...
				success: function(result) {
					...
					try {
						document.getElementById("user-edit-permission-group").value = (data.group_sid !== undefined && data.group_sid > 0) ? data.group_sid : 0;
					} catch (e) {
						console.warn(e);
						return;
					}
		...
		initUserEditContainer: function() {
			...
			try {
				document.getElementById("user-add-permission-group").value = 0;
			} catch (e) {
				console.warn(e);
				return;
			}
		...
		setUserData: function() {
			...
			try {
				data.permissionGroup = document.getElementById("user-add-permission-group").value;
			} catch (e) {
				console.warn(e);
				try {
            		document.getElementById("loading-container").style.display = "none";
		...
		editUserData: function() {
			...
			try {
				data.permissionGroup = document.getElementById("user-edit-permission-group").value;
			} catch (e) {
				console.warn(e);
				try {
            		document.getElementById("loading-container").style.display = "none";
