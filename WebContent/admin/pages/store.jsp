	...
	<div class="jqx-custom-window" id="store-add-window">
		...
		<div class="line" id="store-profile-container"
			...
			<div class="line gray">
				...
				<div class="grid-3">
					<input type="text" class="tax-rate" id="store-add-store-tax-rate"
						style="width: 100%;" />
				</div>
			...
			<div class="line gray">
				<div class="grid-4 title">Use External Clock In/Out</div>
				<div class="grid-1" style="margin-left: 0px;">
					<div class="jqx-check-box" id="check-external-clockio-add" style="width:30px;height:15px;"></div>
				</div>
				<div class="grid-2-5" style="margin-left: 10px;">External Clock In/Out URL</div>
				<div class="grid-4" style="margin-left: 0px;">
					<input type="text" id="store-external-clockio-url-add"
						style="width: 100%" readonly/>
				</div>
			</div>
			...
			<div class="line" style="text-align: center;">
				...
				<div class="jqx-plain-button" style="display:inline-block; width:90px;" onclick="$('#store-add-window').jqxWindow('close');">Cancel</div>
			</div>
		</div>
	</div>
	<div class="jqx-custom-window" id="store-edit-window">
		...
		<div class="line" id="store-profile-container"
			...
			<div class="line gray">
				...
				<div class="grid-3">
					<input type="text" class="tax-rate" id="store-info-store-tax-rate-pop"
						style="width: 100%;" />
				</div>
				<div class="grid-1">%</div>
			</div>
			...
			<div class="line gray">
				<div class="grid-1-5">Override Code</div>
				<div class="grid-4">
					<input type="password" id="store-info-key-code-pop" style="width: 100%;"/>
				</div>
			</div>
			<div class="line gray">
				<div class="grid-1-5">Owner</div>
				<div class="grid-4">
					<input type="text" id="store-info-store-owner-pop" style="width: 100%;" readonly />
				</div>
				<div class="grid-2" style="margin-left: 40px;display:none;">Manager</div>
			...
			<div class="line gray">
				<div class="grid-4 title">Restriction on making sales without Clock In</div>
				<div class="grid-1" style="margin-left: 0px;">
					<div class="jqx-check-box" id="check-sales-clockio" style="width:30px;height:15px;"></div>
				</div>
				<div class="grid-2-5" style="margin-left: 10px;">All permission is allowed</div>
				<div class="grid-1" style="margin-left: 0px;">
					<div class="jqx-check-box" id="check-all-permission" style="width:30px;height:15px;"></div>
				</div>
				<div class="grid-2-5 title">Return only store credit</div>
				<div class="grid-1" style="margin-left: 0px;">
					<div class="jqx-check-box" id="check-return-store-credit" style="width:30px;height:15px;"></div>
				</div>
			</div>
			<div class="line gray">
				<div class="grid-4 title">Use External Clock In/Out</div>
				<div class="grid-1" style="margin-left: 0px;">
					<div class="jqx-check-box" id="check-external-clockio" style="width:30px;height:15px;"></div>
				</div>
				<div class="grid-2-5" style="margin-left: 10px;">External Clock In/Out URL</div>
				<div class="grid-4" style="margin-left: 0px;">
					<input type="text" id="store-external-clockio-url"
						style="width: 100%" readonly/>
				</div>
			</div>
			<div class="line">
				<div class="grid-5 title" style="width:340px;font-weight: bold;font-size: 15px;border-bottom: 1px gray solid;">MetroPCS</div>
			...
			<div class="line" style="text-align: center;">
				...
				<div class="jqx-plain-button" style="display:inline-block; width:90px;" onclick="$('#store-edit-window').jqxWindow('close');">Cancel</div>
			</div>
		</div>
	</div>
