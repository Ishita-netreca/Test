    	...
    	if(components){
    		components.jqxGrid({
            	   ...
            	   columns: [
	        			  ...
	        			  { text: 'Customer', datafield: 'customer_id', width: '15%'},
    	...
    	if(components){
    		components.jqxGrid({
            	   ...
            	   columns: [
            		   ...
            		   { text: 'Status', datafield: 'status_str', width: '15%' },
            		...
            		elem.jqxGrid(
            			{
	                	   ...
	                	   columns: [
	                		   ...
	                		   { text: 'Open Date', datafield: 'OpenDate', width: '8%',filtertype: "date", cellsformat: 'MM/dd/yyyy'},
	                		   ...
	                		   { text: 'Active', datafield: 'Active_str', width: '6%'}
		                     ]
            			});
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                if (result === 1062) {
                    ...
                    alert("Error : There is not enough license.");
                    return;
                } else {
                	try {
                		document.getElementById("loading-container").style.display = "none";
