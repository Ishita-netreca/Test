...
<%
	session.setAttribute("wrp_admin_last_loaded_page", "inventory");
...
<div pagename="inventory" class="theme-02">
			...
			<div class="jqx-tab-panel">
				...
				<div class="jqx-horizontal-split-panel">
					<div class="plain-01-panel" style="height: 60%">
						<div class="title-wrapper" style="height:65px;">
							...
							<div class="right-input-area">
								<div class="line" style="margin-bottom:0px;">
									...
									<input type="checkbox" name="searchCheck" style="margin-right:0px;" id="item-type-phone" onClick="WRPAdminApp.pagescript.searchTypeChecked(this);"/><label style="margin-right: 2px;">Phones</label>
									<!-- <input type="checkbox" name="searchCheck" style="margin-right:0px;" id="item-type-acc" onClick="WRPAdminApp.pagescript.searchTypeChecked(this);"/><label style="margin-right: 2px;">Accessories</label>-->
									<input type="checkbox" name="searchCheck" style="margin-right:0px;" id="item-type-sim" onClick="WRPAdminApp.pagescript.searchTypeChecked(this);"/><label style="margin-right: 2px;">SIM</label>
									<input type="checkbox" name="searchCheck" style="margin-right:0px;" id="instock" onClick="WRPAdminApp.pagescript.searchTypeChecked(this);" /><label style="margin-right: 10px;">In-stock</label>
									Category
								...
								<div class="line" style="float:right;">
									<input type="checkbox" style="margin-right:3px;" id="search-type-imei" /><label style="margin-right: 8px;">IMEI</label>
										...
										<div class="line" style="overflow: hidden;">
											<div class="grid-1-5" style="width:70px;">
												<div class="jqx-radio-button"
													id="serialized-item-history-radio-1" groupName="serialized-item-history">Today</div>
											</div>
											<div class="grid-1-5" style="width:70px;">
												<div class="jqx-radio-button"
													id="serialized-item-history-radio-2" groupName="serialized-item-history">1 Week</div>
											</div>
											...
											<div class="grid-1" style="width:70px;">
												<div class="jqx-plain-button" style="display:inline-block;width:70px" onclick="WRPAdminApp.pagescript.getSalesHistoryBySerialItem();">Search</div>
											</div>
				...
				<div class="jqx-horizontal-split-panel">
					<div class="plain-01-panel" style="height: 60%">
						<div class="title-wrapper">
							...
							<div class="sub-title">information Management</div>
							<div class="left-input-area">
								<!-- <div class="jqx-plain-button" style="display:inline-block;width:100px;" onclick="WRPAdminApp.pagescript.initAccessoryItemDictInfo();">+ ADD ITEM</div> -->
							</div>
							<div class="right-input-area">
								<!-- <input type="checkbox" style="display:none;" name="searchCheck2" id="item-type-acc" onClick="WRPAdminApp.pagescript.searchTypeChecked(this);"/> -->
								...
								<div class="title-wrapper">
									...
									<div class="right-input-area" style="width: 700px;">
										<div class="line" style="overflow: hidden;">
											<div class="grid-1-5">
												<div class="jqx-radio-button"
													id="accessory-sales-history-radio-1" groupName="accessory-sales-history">Today</div>
											</div>
											<div class="grid-1-5">
												<div class="jqx-radio-button"
													id="accessory-sales-history-radio-2" groupName="accessory-sales-history">1 Week</div>
											</div>
											<div class="grid-2-5">
												<div class="jqx-datetime-input"
											...
											<div class="grid-1" style="width:70px;">
												<div class="jqx-plain-button"
													style="float: right;width:70px" onclick="WRPAdminApp.pagescript.getSalesHistoryByAccessory();">Search</div>
											</div>
											<div class="grid-2-5">
				...
				<div class="jqx-horizontal-split-panel">
					<div class="plain-01-panel" style="height: 60%">
						<div class="title-wrapper">
							...
							<div class="right-input-area">
								<label style="margin-left:20px;">Category</label>
								<select id="inventory-service-item-category" style="width:100px" onchange="return false;WRPAdminApp.pagescript.getCategoriesDicListByParentSID(this.value, 0, 'inventory-service-item-category-sub');">
								 	<option value="0" selected> ALL</option>
								 </select>
								 <select id="inventory-service-item-category-sub" style="width:100px" onchange="">
								 	<option value="0" selected> ALL</option>
								 </select>
								<input type="text" class="jqx-text-input" id="inven-service-item-search-keyword" placeholder="keyword" style="width:120px;" onkeydown="if(event.keyCode === 13) { WRPAdminApp.pagescript.getServiceItemDictList(); }"/>
								<div class="jqx-plain-button" id="inven-service-item-search-btn" onclick="WRPAdminApp.EventsModule.onclick(WRPAdminApp.pagescript.getServiceItemDictList);" style="display:inline-block;width:70px;">Search</div>
								<div class="jqx-plain-button" id="excel-inventory-service-item-list" style="display:inline-block;width:50px;">Excel</div>
							</div>
						</div>
						<div style="margin: 3px 50px 0px 32px; height: calc(100% - 53px);">
							<div id="jqx-inventory-items-service-item-list"></div>
						</div>
					</div>
					<div style="height: 39%">
						<div class="jqx-tab-panel">
							...
							<div class="plain-01-panel" style="overflow: auto;">
								...
								<div class="content-wrapper" style="padding-top: 3px;">
									<div class="tab-content" tabname="profile">
										<div class="line" id="service-profile-container">
											<div class="line">
												<div class="grid-3">Item Type</div>
												 
												<div class="grid-3">
													<input type="text" id="service-item-item-type" readonly/>												
												</div> 
											</div>
											<div class="line">
												<div class="grid-3">Item Code</div>
												<div class="grid-3">
													<input type="text" id="service-item-item-code" readonly/>
												</div>
												<div class="grid-3">Model</div>
												<div class="grid-3">
													<input type="text" id="service-item-model" readonly/>
												</div>
											</div>
											<div class="line">
												<div class="grid-3">Description</div>
											...
											<div class="line">
												<div class="grid-3">Company / Carrier</div>
												<div class="grid-3">
													<input type="text" id="service-item-distributor" readonly/>
												</div>
												<div class="grid-3">Manufacturer</div>
												<div class="grid-3">
													<input type="text" id="service-item-manufacturer" readonly/>
												</div>
											</div>
											<div class="line">
												<div class="grid-3">Category</div>
												<div class="grid-3">
													<input type="text" id="service-item-category" readonly/>
												</div>
												<div class="grid-3">Sub Category</div>
												<div class="grid-3">
													<input type="text" id="service-item-sub-category" readonly/>
												</div>
											</div>
											<div class="line">
												<div class="grid-3">Color</div>
												<div class="grid-3">
													<input type="text" id="service-item-color" readonly/>
												</div>
												<div class="grid-3">Condition</div>
												<div class="grid-3">
													<input type="text" id="service-item-condition" readonly/>
												</div>
											</div>
											<div class="line">
												<div class="grid-3">SKU</div>
												<div class="grid-3">
													<input type="text" id="service-item-sku" readonly/>
												</div>
											</div>
											<div class="line">
												<div class="grid-3">Item Cost</div>
												<div class="grid-3">
													<input type="text" id="service-item-item-cost" readonly/>
												</div>
												<div class="grid-3">Qty</div>
												<div class="grid-3">
													<input type="text" id="service-item-qty" readonly/>
												</div>
											</div>
											<div class="line">
												<div class="grid-3">Retail Price</div>
												<div class="grid-3">
													<input type="text" id="service-item-retail-price" readonly/>
												</div>
												<div class="grid-3">Wholesale Price</div>
												<div class="grid-3">
													<input type="text" id="service-item-wholesale-price" readonly/>
												</div>
											</div>
											<div class="line">
												<div class="grid-3">Vendor</div>
												<div class="grid-3">
													<input type="text" id="service-item-vendor" readonly/>													
												</div>
											</div>
										</div>
									</div>
							...
							<div class="plain-01-panel" style="width: 100%; height: 100%;">
								<div class="title-wrapper">
									...
									<div class="right-input-area" style="width: 700px;">
										<div class="line" style="overflow: hidden;">
											<div class="grid-1-5">
												<div class="jqx-radio-button"
													id="service-item-sales-history-radio-1" groupName="service-item-sales-history">1 Week</div>
											</div>
											<div class="grid-1-5">
												<div class="jqx-radio-button"
													id="service-item-sales-history-radio-2" groupName="service-item-sales-history">1 Month</div>
											</div>
											<div class="grid-1-5">
												<div class="jqx-radio-button"
													id="service-item-sales-history-radio-3" groupName="service-item-sales-history">3 Months</div>
											</div>
											<div class="grid-2-5">
												<div class="jqx-datetime-input"
													id="service-item-sales-search-start-date"></div>
											</div>
											<div class="grid-2-5">
												<div class="jqx-datetime-input"
													id="service-item-sales-search-end-date"></div>
											</div>
											<div class="grid-2-5">
												<div class="jqx-plain-button" id="excel-service-item-sales-history"
													style="float: right;">Export to Excel</div>
											</div>
										</div>
									</div>
								...
								<div class="content-wrapper"
									style="padding-top: 3px; margin: 0px 50px 0px 32px;">
									<div id="jqx-service-item-sales-history"></div>
								</div>
							</div>
				...
				<div class="jqx-horizontal-split-panel">
					<div class="plain-01-panel" style="height: 60%">
						<div class="title-wrapper">
							...
							<div class="sub-title">information Management</div>
							<div class="left-input-area" style="visibility: hidden;">
							</div>
							<div class="right-input-area">
								<input type="text" class="jqx-text-input" id="inven-fee-search-keyword" placeholder="keyword" style="width:150px;" onkeydown="if(event.keyCode === 13) { WRPAdminApp.pagescript.getFeeList(); }"/>
								<div class="jqx-plain-button" id="search-inventory-fee" style="display:inline-block;width:80px;" onclick="WRPAdminApp.EventsModule.onclick(WRPAdminApp.pagescript.getFeeList);">Search</div>
								<div class="jqx-plain-button" id="excel-inventory-fee" style="display:inline-block;width:60px;">Excel</div>
							</div>
						</div>
						<div style="margin: 3px 50px 0px 32px; height: calc(100% - 53px);">
							<div id="jqx-inventory-items-fee-list"></div>
						</div>
					</div>
					<div style="height: 39%">
						<div class="jqx-tab-panel">
							...
							<div class="plain-01-panel">
								<div class="title-wrapper">
									<div class="title">Fee Info</div>
								</div>
								<div class="content-wrapper" style="margin: 7px 0px 0px 40px;">
									<div class="line" id="fee-profile-container">
										<div class="line">
											<div class="grid-1">Item Type</div>
											<div class="grid-2">
												<input type="text" id="fee-type" style="width:100%" readonly/>
										...
										<div class="line">
											...
											<div class="grid-2">
												<input type="text" id="fee-name" style="width:100%" readonly/>
											</div>
										</div>
										<div class="line">
											<div class="grid-1">Description</div>
											<div class="grid-2">
												<input type="text" id="fee-description" style="width:100%" readonly/>
											</div>
										</div>
										<div class="line">
											<div class="grid-1">Amount</div>
											<div class="grid-2">
												<input type="text" id="fee-amount" style="width:100%" readonly/>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="title-wrapper">
									...
									<div class="right-input-area" style="width: 700px;">
										<div class="line" style="overflow: hidden;">
											<div class="grid-1-5">
												<div class="jqx-radio-button"
													id="service-sales-history-radio-1" groupName="service-sales-history">Today</div>
											</div>
											<div class="grid-1-5">
												<div class="jqx-radio-button"
													id="service-sales-history-radio-2" groupName="service-sales-history">1 Week</div>
											</div>
											<div class="grid-2-5">
												<div class="jqx-datetime-input"
											...
											<div class="grid-1-5">
												<div class="jqx-plain-button" 
													style="width:80px;float: right;" onclick="WRPAdminApp.pagescript.getSalesHistoryByService();">Search</div>
											</div>
											<div class="grid-2-5">
			...
			<div class="title-wrapper">
				...
				<div class="right-input-area" style="width:680px;">
                   	<div class="line" style="overflow: hidden;">
						...
						<div class="grid-2" style="margin-left:7px;">
							<input type="text" placeholder="invoice no" id="inventory-return-search-keyword" style="width:100px;" onkeydown="if(event.keyCode === 13) { WRPAdminApp.pagescript.getReturnedItemsList(); }"/>
						</div>
						<div class="grid-1-5" style="margin-left:0px;width:87px;">
						...
						<div class="grid-1-5" style="margin-left:5px;">
	...
	<div class="jqx-custom-window" id="serialized-item-window">
		...
		<div id="serialized-profile-add-container" style="padding-top: 15px;">
			...
			<div class="line">
				...
				<div class="grid-3" style="margin-left: -3.5%;"><div class="jqx-plain-button" style="width:50px;height:12px;display:inline-block;" onclick="WRPAdminApp.pagescript.checkItemCodeDuplicate('serialized-item-item-code-pop');">Check</div></div>
				<!-- <DIV CLASS="GRID-3">MODEL</DIV>
				<DIV CLASS="GRID-3">
			...
			<div class="line">
				<!-- <div class="grid-3">Item Code<div class="jqx-plain-button" style="width:50px;height:12px;display:inline-block;" onclick="WRPAdminApp.pagescript.checkItemCodeDuplicate('serialized-item-item-code-pop');">Check</div></div>
				<div class="grid-3">
					<input type="text" id="serialized-item-item-code-pop"
						style="width: 85%;" />
				</div> -->
			...
			<div class="line" style="text-align: center;">
				<div class="jqx-plain-button" style="width:90px;display:inline-block;" id="serialized-item-save-btn"
					onclick="WRPAdminApp.EventsModule.onclick(WRPAdminApp.pagescript.saveSerializedItem);">Save</div>
				<div class="jqx-plain-button" style="width:90px;display:inline-block;" id="serialized-item-cancel-btn"
					onclick="$('#serialized-item-window').jqxWindow('close');">Cancel</div>	
			</div>
		</div>
	</div>
	<div class="jqx-custom-window" id="accessory-edit-window">
		...
		<div id="accessory-add-container">
			...
			<div class="line">
				<!-- <div class="grid-3">Item Code<div class="jqx-plain-button" style="width:50px;height:12px;display:inline-block;" onclick="WRPAdminApp.pagescript.checkItemCodeDuplicate('accessory-item-item-code-pop');">Check</div></div> -->
				<div class="grid-3">Item Code</div>
				<div class="grid-3">
					<input type="text" id="accessory-item-item-code-pop" />
				</div>
				<div class="grid-3" style="margin-left:-0.6%"><div class="jqx-plain-button" style="width:50px;height:12px;display:inline-block;" onclick="WRPAdminApp.pagescript.checkItemCodeDuplicate('accessory-item-item-code-pop');">Check</div></div>
				<!-- <div class="grid-3">Model</div>
				<div class="grid-3">
			...
			<div class="line" style="text-align: center;">
				<div class="jqx-plain-button" style="width:90px;display:inline-block;" id="accessory-item-save-btn" onclick="WRPAdminApp.EventsModule.onclick(WRPAdminApp.pagescript.saveAccessoryItem);">Save</div>
				<div class="jqx-plain-button" style="width:90px;display:inline-block;" id="accessory-item-cancel-btn" onclick="$('#accessory-edit-window').jqxWindow('close');">Cancel</div>
			</div>
		</div>
	</div>
