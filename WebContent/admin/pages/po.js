...
var _pagescript = {
	init: function() {
    	...
    	if (components) {
    		components.jqxGrid({
    			...
    			columns: [
				   ...
				   { text: "P.O ID", datafield: "po_id", width: "15%", align: 'center' },
				   { text: "Vendor ID", datafield: "vendor_id", width: "15%", align: 'center'},
				   { text: "Orderer ID", datafield: "orderer_id", width: "15%", align: 'center'},
				   { text: "Order Date", datafield: "order_date", width: "15%", filtertype: "date", cellsformat: 'MM/dd/yyyy HH:mm:ss' , align: 'center'},
				   { text: "Qty", datafield: "total_ordered_qty", width: "10%", align: 'center' },
				   { text: "Status", datafield: "status_str", width: "10%", align: 'center' },
				   { text: "Item", datafield: "item_info", width: "20%", align: 'center' }
				]
    		});
    	...
    	if (components) {
    		components.jqxGrid({
    			...
    			columns: [
    				...
    				{ text: "order_qty", datafield: "order_qty", width: "25%", align: 'center'},
    				{ text: "fulfill_qty", datafield: "fulfill_qty", width: "25%", align: 'center'},
    				{ text: "item_cost", datafield: "item_cost", width: "25%", cellsformat:"c2",cellsalign:'right', align: 'center'},
    	...
    	if (components) {
    		components.jqxGrid({
    			...
    			columns: [
    				...
    				{ text: "Type", datafield: "type_str", width: "40%", align: 'center'},
    				{ text: "Description", datafield: "description", width: "40%", align: 'center'},
    				{ text: "Cost", datafield: "cost", width: "20%", cellsformat:"c2",cellsalign:'right', align: 'center'}
				]
    		});
    	}
    		...
    		components.jqxGrid({
    			...
    			source: new $.jqx.dataAdapter({
    				...
    				datafields: [
    					...
    					{ name: "orderer_id", type: "string" },
    					{ name: "order_date", type: "date" },
    					{ name: "fulfiller_id", type: "string" },
    					{ name: "fulfill_date", type: "date" },
    					{ name: "vendor_id", type: "string" },
    					{ name: "total_ordered_qty", type: "string" },
    					{ name: "status_str", type: "string" },
    					{ name: "item_info", type: "string" }
    			...
    			columns: [
				   { text: "sid", datafield: "sid", hidden:true },
				   { text: "P.O ID", datafield: "po_id", width: "10%", align: 'center' },
				   { text: "Vendor ID", datafield: "vendor_id", width: "10%", align: 'center'},
				   { text: "Orderer ID", datafield: "orderer_id", width: "10%", align: 'center'},
				   { text: "Order Date", datafield: "order_date", width: "10%", filtertype: "date", cellsformat: 'MM/dd/yyyy HH:mm:ss', align: 'center' },
				   { text: "Fulfiller ID", datafield: "fulfiller_id", width: "10%", align: 'center'},
				   { text: "Fulfill Date", datafield: "fulfill_date", width: "10%", filtertype: "date", cellsformat: 'MM/dd/yyyy HH:mm:ss', align: 'center' },
				   { text: "Qty", datafield: "total_ordered_qty", width: "10%", align: 'center' },
				   { text: "Status", datafield: "status_str", width: "10%", align: 'center' },
				   { text: "Item", datafield: "item_info", width: "20%", align: 'center' }
				]
    	...
    	if (components) {
    		components.jqxGrid({
    			...
    			columns: [
    				{ text: "sid", datafield: "sid", hidden:true },
 				   { text: "P.O ID", datafield: "po_id", width: "9%" , align: 'center'},
 				   { text: "Vendor ID", datafield: "vendor_id", width: "9%", align: 'center'},
 				   { text: "Orderer ID", datafield: "orderer_id", width: "9%", align: 'center'},
 				   { text: "Order Date", datafield: "order_date", width: "9%", filtertype: "date", cellsformat: 'MM/dd/yyyy HH:mm:ss', align: 'center' },
 				   { text: "Fulfiller ID", datafield: "fulfiller_id", width: "9%", align: 'center'},
 				   { text: "Fulfill Date", datafield: "fulfill_date", width: "9%", filtertype: "date", cellsformat: 'MM/dd/yyyy HH:mm:ss', align: 'center' },
 				   { text: "Receiver ID", datafield: "receiver_id", width: "9%", align: 'center'},
				   { text: "Receive Date", datafield: "receive_date", width: "9%", filtertype: "date", cellsformat: 'MM/dd/yyyy HH:mm:ss', align: 'center' },
 				   { text: "Qty", datafield: "total_ordered_qty", width: "5%", align: 'center' },
 				   { text: "Status", datafield: "status_str", width: "5%", align: 'center' },
 				   { text: "Item", datafield: "item_info", width: "18%" , align: 'center'}
				]
    		});
    		/* 170208 jh*/
    	...
    	if (components) {
    		components.jqxGrid({
    			...
    			columns: [
    				...
    				{ text: "description", datafield: "description", width: "25%", align: 'center'},
    				{ text: "fulfill_qty", datafield: "fulfill_qty", width: "25%", align: 'center'},
    				{ text: "receive_qty", datafield: "receive_qty", width: "25%", align: 'center'},
    				{ text: "item_cost", datafield: "item_cost", width: "25%", cellsformat:"c2",cellsalign:'right', align: 'center'},
    				{ text: "status", datafield: "status", width: "20%", hidden: true  },
    				{ text: "order_date", datafield: "order_date", width: "20%", hidden: true  },
    				{ text: "receive_date", datafield: "received_date", width: "25%", hidden: true  }
    	...
    	if (components) {
    		...
    		components.jqxWindow("height", "90%");
    		components.jqxWindow("resizable", false);
    		components.jqxWindow("position", { x:((window.innerWidth * 0.5) - 400) , y: (((window.innerHeight * 0.5) - 400) < 0)? 10 : (window.innerHeight * 0.5) - 400  });
    	...
    	if (components) {
    		components.jqxGrid({
    			...
    			columns: [
				   ...
				   { text: "Item Code", datafield: "item_code", width: "120px", align: 'center' },
				   { text: "Model", datafield: "model", width: "210px", align: 'center' },
				   { text: "Description", datafield: "description", width: "34%", align: 'center'},
				   { text: "SKU", datafield: "sku", width: "100px", align: 'center' },
				   { text: "Cost", datafield: "item_cost", width: "80px", cellsformat: "c2",cellsalign:'right', align: 'center' },
				   { text: "In Stock", datafield: "in_stock", width: "8%", align: 'center' },
    	...
    	if (components) {
    		...
    		components.jqxGrid({
    			...
    			columns: [
				   ...
				   { datafield: "item_type", hidden:true },
				   { text: "Item Code", datafield: "item_code", width: "120px", editable: false, align: 'center' },
				   { text: "SKU", datafield: "sku", width: "100px", editable: false, align: 'center' },
				   { text: "Description", datafield: "description", width: "33.5%", editable: false, align: 'center'},
				   { text: "Cost", datafield: "item_cost", width: "70px", cellsformat: "c2",cellsalign:'right', editable: true , align: 'center'},
				   { text: "Qty", datafield: "pre_qty", width: "9%", editable: true, align: 'center' },
				   { text: "Added IMEI", datafield: "qty", width: "9%", editable: false, align: 'center' },
				   { text: "SubTotal", datafield: "sub_total", width: "70px", cellsformat: "c2", editable: false,cellsalign:'right', align: 'center'},
    		...
    		components.on("cellendedit", function(event) { if(event.args.datafield==="pre_qty" || event.args.datafield==="item_cost") { setTimeout(function() { WRPAdminApp.POModule.printExpressPOItemsList('po-express-added-items-list'); document.getElementById("po-express-total-cost").innerHTML = "$"+WRPAdminApp.POModule.getExpressPOTotalCost().toFixed(2); }, 500); } });
    	...
    	*/
    	...
    	if (components) {
    		components.jqxGrid({
    			...
    			columns: [
				   ...
				   { text: "Type", datafield: "type_str", width: "30%", align: 'center'},
				   { text: "Description", datafield: "description", width: "49.5%", align: 'center'},
				   { text: "Cost", datafield: "cost", width: "10%", cellsformat: "c2",cellsalign:'right', align: 'center' },
    	...
    	if (components) {
    		components.jqxGrid({
    			...
    			columns: [
				   { text: "sid", datafield: "sid", hidden:true },
				   { text: "Vendor ID", datafield: "vendor_id", width: "50%", align: 'center'},
				   { text: "Vendor Name", datafield: "vendor_name", width: "50%", align: 'center'}
				]
    		});
    	...
    	if (components) {
    		components.jqxGrid({
    			...
    			columns: [
				   ...
				   { text: "Model", datafield: "model", width: "20%", align: 'center' },
				   { text: "Description", datafield: "description", width: "20%", align: 'center'},
				   { text: "SKU", datafield: "sku", width: "15%", align: 'center' },
				   { text: "Cost", datafield: "item_cost", width: "10%", cellsformat: "c2",cellsalign:'right', align: 'center' },
				   { text: "In Stock", datafield: "in_stock", width: "10%", align: 'center' },
    	...
    	if (components) {
    		components.jqxGrid({
    			...
    			columns: [
				   { datafield: "item_sid", hidden:true },
				   { datafield: "item_type", hidden:true },
				   { text: "Item Code", datafield: "item_code", width: "20%", editable: false, align: 'center' },
				   { text: "SKU", datafield: "sku", width: "20%", editable: false, align: 'center' },
				   { text: "Description", datafield: "description", width: "25%", editable: false, align: 'center'},
				   { text: "Cost", datafield: "item_cost", width: "10%", cellsformat: "c2", editable: true,cellsalign:'right', align: 'center' },
				   { text: "Qty", datafield: "qty", width: "5%", align: 'center' },
				   { text: "Sub Total", datafield: "sub_total", width: "10%", cellsformat: "c2", editable: false,cellsalign:'right', align: 'center' },
    	...
    	if (components) {
    		components.jqxGrid({
    			...
    			columns: [
				   ...
				   { text: "Item Code", datafield: "item_code", width: "20%", editable: false , align: 'center'},
				   { text: "SKU", datafield: "sku", width: "20%", editable: false, align: 'center' },
				   { text: "Description", datafield: "description", width: "35%", editable: false, align: 'center'},
				   { text: "Odr Qty", datafield: "order_qty", width: "10%", align: 'center' },
				   { text: "Ffl Qty", datafield: "fulfill_qty", width: "10%", align: 'center' },
    	...
    	if (components) {
    		components.jqxGrid({
    			...
    			columns: [
				   ...
				   { text: "Description", datafield: "description", width: "35%", editable: false, align: 'center'},
				   { text: "Ffl Qty", datafield: "fulfill_qty", width: "10%", align: 'center' },
				   { text: "Recv Qty", datafield: "receive_qty", width: "10%", align: 'center' },
				   { text: "", datafield: "", width: "5%", editable: false, cellsRenderer: function (row, column, value, rowData) { return '<div class="confirm-item-btn" title="Confirm"></div>'; } }
				]
    		});
    	...
    	$('#purchase-order-radio-1').on('checked', function (event) {
            var start, end;
				...
				$("#jqx-purchase-order-start-date").jqxDateTimeInput('setDate', start);
				$("#jqx-purchase-order-end-date").jqxDateTimeInput('setDate', end);
		 });
		 
		 $('#purchase-order-radio-2').on('checked', function (event) {
			 var start, end;
				var date = WRPCommon.TimeModule.getTime();
				end = WRPAdminApp.toDecimalFormat((date.getMonth() + 1), "00") + "/" + WRPAdminApp.toDecimalFormat(date.getDate(), "00") + "/" + date.getFullYear();
		 ...
		 $('#purchase-order-radio-3').on('checked', function (event) {
			 var start, end;
				var date = WRPCommon.TimeModule.getTime();
				end = WRPAdminApp.toDecimalFormat((date.getMonth() + 1), "00") + "/" + WRPAdminApp.toDecimalFormat(date.getDate(), "00") + "/" + date.getFullYear();
		 ...
		 $('#purchase-order-appr-radio-1').on('checked', function (event) {
            var start, end;
				var date = WRPCommon.TimeModule.getTime();
				end = WRPAdminApp.toDecimalFormat((date.getMonth() + 1), "00") + "/" + WRPAdminApp.toDecimalFormat(date.getDate(), "00") + "/" + date.getFullYear();
				date.setDate(date.getDate());
				start = WRPAdminApp.toDecimalFormat((date.getMonth() + 1), "00") + "/" + WRPAdminApp.toDecimalFormat(date.getDate(), "00") + "/" + date.getFullYear();
				$("#jqx-purchase-order-appr-start-date").jqxDateTimeInput('setDate', start);
				$("#jqx-purchase-order-appr-end-date").jqxDateTimeInput('setDate', end);
		 });
		 
		 $('#purchase-order-appr-radio-2').on('checked', function (event) {
			 var start, end;
				var date = WRPCommon.TimeModule.getTime();
				end = WRPAdminApp.toDecimalFormat((date.getMonth() + 1), "00") + "/" + WRPAdminApp.toDecimalFormat(date.getDate(), "00") + "/" + date.getFullYear();
				date.setDate(date.getDate()-7);
		 ...
		 $('#purchase-order-appr-radio-3').on('checked', function (event) {
			 var start, end;
				var date = WRPCommon.TimeModule.getTime();
				end = WRPAdminApp.toDecimalFormat((date.getMonth() + 1), "00") + "/" + WRPAdminApp.toDecimalFormat(date.getDate(), "00") + "/" + date.getFullYear();
				date.setMonth(date.getMonth()-1);
		 ...
		 $('#purchase-order-recv-radio-1').on('checked', function (event) {
            var start, end;
				var date = WRPCommon.TimeModule.getTime();
				end = WRPAdminApp.toDecimalFormat((date.getMonth() + 1), "00") + "/" + WRPAdminApp.toDecimalFormat(date.getDate(), "00") + "/" + date.getFullYear();
				date.setDate(date.getDate());
				start = WRPAdminApp.toDecimalFormat((date.getMonth() + 1), "00") + "/" + WRPAdminApp.toDecimalFormat(date.getDate(), "00") + "/" + date.getFullYear();
				$("#jqx-purchase-order-recv-start-date").jqxDateTimeInput('setDate', start);
				$("#jqx-purchase-order-recv-end-date").jqxDateTimeInput('setDate', end);
		 });
		 
		 $('#purchase-order-recv-radio-2').on('checked', function (event) {
			 var start, end;
				var date = WRPCommon.TimeModule.getTime();
				end = WRPAdminApp.toDecimalFormat((date.getMonth() + 1), "00") + "/" + WRPAdminApp.toDecimalFormat(date.getDate(), "00") + "/" + date.getFullYear();
				date.setDate(date.getDate()-7);
		 ...
		 $('#purchase-order-recv-radio-3').on('checked', function (event) {
			 var start, end;
				var date = WRPCommon.TimeModule.getTime();
				end = WRPAdminApp.toDecimalFormat((date.getMonth() + 1), "00") + "/" + WRPAdminApp.toDecimalFormat(date.getDate(), "00") + "/" + date.getFullYear();
				date.setMonth(date.getMonth()-1);
		 ...
		 $('#purchase-order-complete-radio-1').on('checked', function (event) {
            var start, end;
				var date = WRPCommon.TimeModule.getTime();
				end = WRPAdminApp.toDecimalFormat((date.getMonth() + 1), "00") + "/" + WRPAdminApp.toDecimalFormat(date.getDate(), "00") + "/" + date.getFullYear();
				date.setDate(date.getDate());
				start = WRPAdminApp.toDecimalFormat((date.getMonth() + 1), "00") + "/" + WRPAdminApp.toDecimalFormat(date.getDate(), "00") + "/" + date.getFullYear();
				$("#jqx-purchase-order-complete-start-date").jqxDateTimeInput('setDate', start);
				$("#jqx-purchase-order-complete-end-date").jqxDateTimeInput('setDate', end);
		 });
		 
		 $('#purchase-order-complete-radio-2').on('checked', function (event) {
			 var start, end;
				var date = WRPCommon.TimeModule.getTime();
				end = WRPAdminApp.toDecimalFormat((date.getMonth() + 1), "00") + "/" + WRPAdminApp.toDecimalFormat(date.getDate(), "00") + "/" + date.getFullYear();
				date.setDate(date.getDate()-7);
		 ...
		 $('#purchase-order-complete-radio-3').on('checked', function (event) {
			 var start, end;
				var date = WRPCommon.TimeModule.getTime();
				end = WRPAdminApp.toDecimalFormat((date.getMonth() + 1), "00") + "/" + WRPAdminApp.toDecimalFormat(date.getDate(), "00") + "/" + date.getFullYear();
				date.setMonth(date.getMonth()-1);
    	...
    	$('#purchase-order-radio-1').jqxRadioButton('check');
    	$('#purchase-order-appr-radio-1').jqxRadioButton('check');
    	$('#purchase-order-recv-radio-1').jqxRadioButton('check');
    	$('#purchase-order-complete-radio-1').jqxRadioButton('check');
    ...
    onExpressPOAddedItemsListConfirmButtonClick: function(index) {
    	...
    	page = window.document.getElementById("po-express-confirm-serial-no-list");
    ...
    addCostInExpress: function() {
    	...
    	if (isNaN(data.cost)) {
    		WRPCommon.MsgBoxModule.alert({
    			message: "Cost contains non-numeric characters",
    			okBtnClick: function(){
    				elem.jqxInput("focus");
    			}
    		});
    ...
    onNewPOAddedItemsListCellEndEdit: function(event) {
    	...
    	try {
    		if (event.args.datafield === "qty") {
        		...
        		if (isNaN(value)) {
            		WRPCommon.MsgBoxModule.alert({
            			message: "Qty contains non-numeric characters"
            		});
        			return;
        		}
    		...
    		} else if (event.args.datafield === "item_cost") {
        		value = parseInt(event.args.value);
        		if (isNaN(value)) {
            		WRPCommon.MsgBoxModule.alert({
        		...
        		if (event.args.row !== undefined) {
            		WRPAdminApp.POModule.setItemCostInNewPOAddedItem("new-po-added-items-list", event.args.row.item_sid, value);
        	    	document.getElementById("new-po-total-cost").innerHTML = "$"+WRPAdminApp.POModule.getNewPOTotalCost().toFixed(2);
        		}
    		}
    	} catch (e) {
    ...
    submitFulfillNonSerializedItem: function() {
    	...
    	try {
    		...
    		if (isNaN(ffl_qty)) {
        		WRPCommon.MsgBoxModule.alert({
        			message: "Fulfill Qty contains non-numeric characters"
        		});
    			return;
    		}
    	} catch (e) {
    ...
    submitReceiveNonSerializedItem: function() {
    	...
    	try {
    		...
    		if (isNaN(recv_qty)) {
    			WRPCommon.MsgBoxModule.alert({
    				message: "Receive Qty contains non-numeric characters"
    			});
    			return;
    		}
    	} catch (e) {
