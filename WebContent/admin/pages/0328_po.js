...
var _pagescript = {
	init: function() {
    	...
    	if (components) {
    		...
    		components.jqxWindow("height", 840);
    		components.jqxWindow("position", { x:((window.innerWidth * 0.5) - 400) , y: ((window.innerHeight * 0.5) - 420) });
    	}
    	...
    	if (components) {
    		components.jqxGrid({
    			...
    			columns: [
				   ...
				   { datafield: "item_type", hidden:true },
				   { text: "Item Code", datafield: "item_code", width: "15%", editable: false },
				   { text: "SKU", datafield: "sku", width: "15%", editable: false },
				   ...
				   { text: "Qty * Cost", datafield: "sub_total", width: "10%", cellsformat: "c2", editable: false },
				   { text: "", columntype: 'button', width: "10%", editable: false, cellsrenderer: function(){ return "Input"; }, buttonclick: WRPAdminApp.pagescript.onExpressPOAddedItemsListConfirmButtonClick },
				   { text: "", columntype: 'button', width: "10%", editable: false, cellsrenderer: function(){ return "Delete"; }, buttonclick: WRPAdminApp.pagescript.onExpressPOAddedItemsListDeleteButtonClick }
    	...
    	if (components) {
    		...
    		components.jqxWindow("height", 840);
    		components.jqxWindow("position", { x:((window.innerWidth * 0.5) - 210) , y: ((window.innerHeight * 0.5) - 420) });
    	}
    ...
    inputSerialNoInExpresss: function(serial_no) {
		...
		$.ajax({
            ...
            success: function(result) {
        		...
        		WRPAdminApp.POModule.inputSerialNo(serial_no, 'po-express-confirm-serial-no-list','<div class=\'item\'><div class=\'serial\' id=\'sn'+serial_no+'\'>{serial}</div><div class=\'remove-item-btn\' onclick=\'this.parentNode.parentNode.removeChild(this.parentNode);\'></div></div>');
            }
        });
    },
