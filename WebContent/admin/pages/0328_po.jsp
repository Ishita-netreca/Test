...
<%
    session.setAttribute("wrp_last_loaded_page", "po");
%>
	 ...
	 <div class="jqx-custom-window" id="po-express-confirm-serialized-item-window">
	 	...
	 	<div role="content" class="jqx-full-sized-dock-panel">
            ...
            <div class="line">
                ...
                <div class="grid-2" >
	                <div class="btn round" onclick="WRPAdminApp.pagescript.inputSerialNoInExpresss(document.getElementById('new-po-search-item-keyword').value); document.getElementById('new-po-search-item-keyword').value = '';"><div class="icon" style="background-image: url('img/icon/keyboard-01.png');"></div><div class="label">Input</div></div>
                </div>
            </div>
            <!--  
            <div class="line">
