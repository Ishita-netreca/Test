...
<div pagename="conf_sys" class="theme-02">
	<div class="page-submenu-container" style="">
        ...
        <div class="border"></div>
        <div class="submenu" panelname="chart_of_account" onclick="WRPAdminApp.setSubMenuPage('cashRegister');">
            Station
        </div>
        <div class="border"></div>
        <div class="submenu" panelname="dt_setup" onclick="WRPAdminApp.pagescript.setSubMenuPage('dt_setup');">
            Date & Time Setup
        </div>
        <div class="border"></div>
        <div class="submenu" panelname="emp_roles" onclick="WRPAdminApp.pagescript.setSubMenuPage('emp_roles');">
            Employee Roles
        </div>
        <div class="border"></div>
        <div class="submenu" panelname="permission_group" onclick="WRPAdminApp.pagescript.setSubMenuPage('permission_group');">
            Permission Group
        </div>
        <div class="border"></div>
        <div class="submenu" panelname="store_location" onclick="WRPAdminApp.pagescript.setSubMenuPage('store_location');">
            Region Setup
        </div>
        <div class="border"></div>
        <div class="submenu" panelname="store_location" onclick="WRPAdminApp.pagescript.setSubMenuPage('qpay_favorite_providers');">
            Qpay Favorite
        </div>
    </div>
    <div class="panels" style="height:100%" id="sub_">
