	...
	init: function() {
    	...
    	if (components) {
    		components.jqxGrid({
    			...
    			columns: [
				   ...
				   { text: "P.O ID", datafield: "po_id", width: "15%" },
				   { text: "Vendor ID", datafield: "vendor_id", width: "15%"},
				   { text: "Orderer ID", datafield: "orderer_id", width: "15%"},
				   { text: "Order Date", datafield: "order_date", width: "15%", filtertype: "date", cellsformat: 'MM/dd/yyyy HH:mm:ss' },
				   { text: "Qty", datafield: "total_ordered_qty", width: "10%" },
				   { text: "Status", datafield: "status_str", width: "10%" },
				   { text: "Item", datafield: "item_info", width: "20%" }
				]
    		});
    	...
    	if (components) {
    		components.jqxGrid({
    			...
    			columns: [
				   { text: "sid", datafield: "sid", hidden:true },
				   { text: "P.O ID", datafield: "po_id", width: "10%" },
				   { text: "Vendor ID", datafield: "vendor_id", width: "10%"},
				   { text: "Orderer ID", datafield: "orderer_id", width: "10%"},
				   { text: "Order Date", datafield: "order_date", width: "10%", filtertype: "date", cellsformat: 'MM/dd/yyyy HH:mm:ss' },
				   { text: "Fulfiller ID", datafield: "fulfiller_id", width: "10%"},
				   { text: "Fulfill Date", datafield: "fulfill_date", width: "10%", filtertype: "date", cellsformat: 'MM/dd/yyyy HH:mm:ss' },
				   { text: "Qty", datafield: "total_ordered_qty", width: "10%" },
				   { text: "Status", datafield: "status_str", width: "10%" },
				   { text: "Item", datafield: "item_info", width: "20%" }
				]
    	...
    	if (components) {
    		components.jqxGrid({
    			...
    			columns: [
    				{ text: "sid", datafield: "sid", hidden:true },
 				   { text: "P.O ID", datafield: "po_id", width: "9%" },
 				   { text: "Vendor ID", datafield: "vendor_id", width: "9%"},
 				   { text: "Orderer ID", datafield: "orderer_id", width: "9%"},
 				   { text: "Order Date", datafield: "order_date", width: "9%", filtertype: "date", cellsformat: 'MM/dd/yyyy HH:mm:ss' },
 				   { text: "Fulfiller ID", datafield: "fulfiller_id", width: "9%"},
 				   { text: "Fulfill Date", datafield: "fulfill_date", width: "9%", filtertype: "date", cellsformat: 'MM/dd/yyyy HH:mm:ss' },
 				   { text: "Receiver ID", datafield: "receiver_id", width: "9%"},
				   { text: "Receive Date", datafield: "receive_date", width: "9%", filtertype: "date", cellsformat: 'MM/dd/yyyy HH:mm:ss' },
 				   { text: "Qty", datafield: "total_ordered_qty", width: "5%" },
 				   { text: "Status", datafield: "status_str", width: "5%" },
 				   { text: "Item", datafield: "item_info", width: "18%" }
				]
    		});
    		/* 170208 jh*/
    	...
    	if (components) {
    		...
    		components.jqxGrid({
    			...
    			columns: [
				   ...
				   { text: "Cost", datafield: "item_cost", width: "70px", cellsformat: "c2", editable: true },
    ...
    inputSerialNoInExpresss: function(serial_no) {
		...
		$.ajax({
            ...
            success: function(result) {
                ...
                if($("#sn"+serial_no).val() != undefined) { alert("Serial exist."); return; }
