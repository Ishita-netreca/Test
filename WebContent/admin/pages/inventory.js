...
var _pagescript = {
    	...
    	*/
    	...
    	if (components) {
    		components.jqxGrid({
    	        ...
    	        columnsresize:true,
    			columns: [
		          	  { text: 'Serial No.', datafield: 'serialNo', width: '20%',  cellsalign: 'right', editable: false, align: 'center'},
                      { text: 'P.O.ID', datafield: 'poId', width: '20%',  cellsalign: 'right', editable: false, align: 'center' },
        			  { text: 'Vendor', datafield: 'Vendor', width: '20%', cellsalign: 'right', editable: false, align: 'center'},
        			  { text: 'Update Date', datafield: 'updateDate', width: '20%',  cellsalign: 'right', editable: false, align: 'center' },
        			  { text: 'Update User', datafield: 'user_id', width: '20%', cellsalign: 'right', editable: false, align: 'center' }
				]
    		});
    	}
    	...
    	if (components) {
    		components.jqxGrid({
    	        ...
    	        columnsresize:true,
    			columns: [
		          		  { text: 'SID', datafield: 'sid', width: '10%', editable: false, hidden:true },
	                      { text: 'SKU', datafield: 'sku', width: '10%', editable: false, hidden:true },
	                      { text: 'Item Code', datafield: 'item_code', width: '10%', editable: false, align: 'center' },
	        			  { text: 'Description', datafield: 'description', width: '23%', editable: false, align: 'center'},
	        			  { text: 'Company/Carrier', datafield: 'distributor', width: '10%', editable: false, align: 'center' },
	        			  { text: 'Category', datafield: 'category', width: '10%', editable: false, align: 'center' },
	        			  { text: 'Sub-Category', datafield: 'sub_category', width: '10%', editable: false, align: 'center' },
	                      { text: 'Manufacturer', datafield: 'manufacturer', width: '13%',editable: false, align: 'center' },
	                      { text: 'Color', datafield: 'color', width: '10%', editable: false, align: 'center' },
	        			  { text: 'Qty', datafield: 'qty', width: '4%', editable: false, align: 'center' },
	                      { text: 'Item Cost', datafield: 'item_cost', width: '5%', cellsalign: 'right', editable: false, cellsformat:"c2", align: 'center' },
	                      { text: 'SRP', datafield: 'retail_price', width: '5%', cellsalign: 'right', editable: false, cellsformat:"c2", align: 'center' },
	                      { text: 'img', datafield: 'image', width: '5%', align: 'center'}
				]
    		});
    		...
    		components.on("rowselect", function (event) {
    			...
    			WRPAdminApp.pagescript.getSalesHistoryBySerialItem();
    	...
    	if (components) {
    		components.jqxGrid({
    			...
    			columns: [
    				...
    				{ text: "Item Code", datafield: "item_code", width: "10%", align: 'center' },
    				{ text: "Description", datafield: "description", width: "23%", align: 'center' },
    				{ text: "Company / Carrier", datafield: "distributor", width: "10%", align: 'center'},
    				{ text: "Category", datafield: "category", width: "10%", align: 'center' },
    				{ text: "Sub-Category", datafield: "sub_category", width: "10%", align: 'center' },
    				{ text: "Manufacturer", datafield: "manufacturer", width: "13%", align: 'center' },
    				{ text: "Color", datafield: "color", width: "10%", align: 'center' },
    				{ text: "Qty", datafield: "qty", width: "4%", align: 'center' },
    				{ text: "Item Cost", datafield: "item_cost", width: "5%", cellsalign:"right", cellsformat:"c2", align: 'center'},
    				{ text: "SRP", datafield: "retail_price", width: "5%", cellsalign:"right", cellsformat:"c2", align: 'center'}
				]
    		});
    		/*///*/
    		components.on("rowselect", function(event){
    			WRPAdminApp.pagescript._selectedAccessoryItemSid = event.args.row.sid;
    			WRPAdminApp.pagescript.getPoHistoryByAccessory(event.args.row.sid);
    			WRPAdminApp.pagescript.getSalesHistoryByAccessory();
    		});
    	...
    	components = $('#jqx-inventory-items-service-item-list');
    	if (components) {
    		components.jqxGrid({
    			width: "100%",
    			height: "100%",
    		...
    		components.on("rowselect", WRPAdminApp.pagescript.informServiceItemDictInfo);
    		//components.on("rowdoubleclick", WRPAdminApp.pagescript.editAccessoryItemDictPop);
    	}
    	
    	components = $('#jqx-inventory-items-fee-list');
    	if (components) {
    		components.jqxGrid({
    			width: "100%",
    			height: "100%",
    			...
    			columns: [
    				{ text: "sid", datafield: "sid", hidden: true },
    				{ text: "Type", datafield: "feeType", width: "25%", align: 'center' },
    				{ text: "Name", datafield: "name", width: "25%", align: 'center' },
    				{ text: "Description", datafield: "description", width: "25%", align: 'center'},
    				{ text: "Amount", datafield: "amount", width: "25%", cellsalign: "right", cellsformat: "c2", align: 'center'}
				]
    		});
    	...
    	if (components) {
    		components.jqxGrid({
    			...
    			columns: [
    				...
    				{ text: "P.O Id", datafield: "poId", width: "16%", align: 'center' },
    				{ text: "Create Date", datafield: "orderDate", width: "20%", align: 'center'},
    				{ text: "Vendor Id", datafield: "vendorId", width: "16%", align: 'center'},
    				{ text: "Status", datafield: "statusStr", width: "16%", align: 'center'},
    				{ text: "Qty", datafield: "total_order_qty", width: "16%", align: 'center'},
    				{ text: "Amount", datafield: "amount", width: "16%", cellsalign: "right", cellsformat: "c2" , align: 'center'}
				]
    		});
    	...
    	if (components) {
    		components.jqxGrid({
    			...
    			columns: [
    				{ text: "sid", datafield: "sid", hidden: true },
    				{ text: "Date", datafield: "date",filtertype : "date",cellsformat : 'MM/dd/yyyy HH:mm:ss', width: "25%", align: 'center' },
    				{ text: "User", datafield: "user_id", width: "25%", align: 'center' },
    				{ text: "Serial", datafield: "serial_no", width: "25%", align: 'center' },
    				{ text: "Qty", datafield: "qty", width: "25%", align: 'center'}
				]
    		});
    	...
    	if (components) {
    		components.jqxGrid({
    			...
    			columns: [
    				...
    				{ text: "Vendor Id", datafield: "vendorId", width: "16%", align: 'center'},
    				{ text: "Status", datafield: "statusStr", width: "16%", align: 'center'},
    				{ text: "Qty", datafield: "totalOrderQty", width: "16%", align: 'center'},
    				{ text: "Amount", datafield: "amount", width: "16%", cellsalign: "right", cellsformat: "c2", align: 'center' }
				]
    		});
    	...
    	if (components) {
    		components.jqxGrid({
    			...
    			columns: [
    				{ text: "sid", datafield: "sid", hidden: true },
    				{ text: "Date", datafield: "date", width: "25%",filtertype : "date",cellsformat : 'MM/dd/yyyy HH:mm:ss', align: 'center' },
    				{ text: "User", datafield: "user_id", width: "25%", align: 'center' },
    				{ text: "Serial", datafield: "serial_no", width: "25%", align: 'center' },
    				{ text: "Qty", datafield: "qty", width: "25%", align: 'center'}
				]
    	...
    	//accessories - sales
    	components = $('#jqx-service-item-sales-history');
    	if (components) {
    		components.jqxGrid({
    			width: "100%",
    			height: "100%",
    	...
    	//service items - sales
    	/*
    	components = $('#jqx-fee-sales-history');
    	if (components) {
    		components.jqxGrid({
    			width: "100%",
    			height: "100%",
    			...
    			columns: [
    				{ text: "sid", datafield: "sid", hidden: true },
    				{ text: "Date", datafield: "date", width: "33%", align: 'center' },
    				{ text: "User", datafield: "user_id", width: "34%", align: 'center' },
    				{ text: "Qty", datafield: "qty", width: "33%", align: 'center'}
				]
    		});
    	...
    	*/
    	...
    	if (components) {
    		components.jqxGrid({
    	        ...
    	        columnsresize:true,
    			columns: [
    				{ text: 'Invoice No.', datafield: 'invoiceNo', width: '10%', align: 'center' },
    				{ text: 'Return Date', datafield: 'returnDate', width: '15%',filtertype: "date", cellsformat: 'MM/dd/yyyy', align: 'center'},
    				{ text: 'Item Code', datafield: 'itemCode', width: '10%', align: 'center'},
    				{ text: 'Description', datafield: 'description', width: '15%', align: 'center' },
    				{ text: 'Serial No.', datafield: 'serialNo', width: '10%', align: 'center'},
    				{ text: 'Qty', datafield: 'qty', width: '10%', align: 'center'},
    				{ text: 'Price', datafield: 'price', width: '10%', cellsformat:'c2', cellsalign:'right', align: 'center'},
    				{ text: 'Tax Amnt', datafield: 'taxAmnt', width: '10%', cellsformat:'c2', cellsalign:'right', align: 'center'},
    				{ text: 'Sub Total', datafield: 'subTotal', width: '10%', cellsformat:'c2', cellsalign:'right', align: 'center'}
				]
    		});
    	...
    	if (components) {
    		components.jqxGrid({
    	        ...
    	        columnsresize:true,
    			columns: [
				   { text: "Reason", datafield: "return_reason", width: "25%", align: 'center' },
				   { text: "Description", datafield: "description", width: "25%", align: 'center' },
				   { text: "Update Date", datafield: "date", width: "25%", filtertype: "date", cellsformat: 'MM/dd/yyyy', align: 'center'},
				   { text: "Updater", datafield: "user_name", width: "25%", align: 'center' },
				   { text: "sid", datafield: "sid", hidden: true }
				]
    		});
		...
		$('#accessory-sales-history-radio-2').on('checked', function (event) {
       	...
       	/*
       	$('#service-sales-history-radio-1').on('checked', function (event) {
			var start, end;
			var date = WRPCommon.TimeModule.getTime();
			end = WRPAdminApp.toDecimalFormat((date.getMonth() + 1), "00") + "/" + WRPAdminApp.toDecimalFormat(date.getDate(), "00") + "/" + date.getFullYear();
			date.setDate(date.getDate());
			start = WRPAdminApp.toDecimalFormat((date.getMonth() + 1), "00") + "/" + WRPAdminApp.toDecimalFormat(date.getDate(), "00") + "/" + date.getFullYear();
			$("#service-sales-search-start-date").jqxDateTimeInput('setDate', start);
			$("#service-sales-search-end-date").jqxDateTimeInput('setDate', end);
		});

		$('#service-sales-history-radio-2').on('checked', function (event) {
			var start, end;
			var date = WRPCommon.TimeModule.getTime();
			end = WRPAdminApp.toDecimalFormat((date.getMonth() + 1), "00") + "/" + WRPAdminApp.toDecimalFormat(date.getDate(), "00") + "/" + date.getFullYear();
			date.setDate(date.getDate()-7);
    ...
    getSerializedItemDictList: function() {
		...
		try {
			if(document.getElementById("search-type-imei").checked == true){
				param.searchImei = document.getElementById("inven-serialized-items-search-keyword").value;
			}else {
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                try {
                    ...
                    $("#serialized-item-save-btn").css("visibility", "visible");
                    $('#serialized-item-window').jqxWindow({title: "Edit Serialized Item"});
    ...
    initSerializedItemDictInfo: function() {
        ...
        $("#serialized-item-save-btn").css("visibility", "visible");
        $('#serialized-item-window').jqxWindow({title: "Add Serialized Item"});
        $('#serialized-item-window').jqxWindow('open');
    },
    ...
    saveSerializedItem: function() {
        ...
        try {
            ...
            console.warn(e);
        	WRPCommon.MsgBoxModule.alert({
        		message: "Item Cost contains non-numeric character"
        	});
            return;
        }
    ...
    callBackUploadSerializedItemImageFile: function(imageUrl, state) { // img path
        ...
        try {
            ...
            console.warn(e);
        	WRPCommon.MsgBoxModule.alert({
        		message: "Retail Price contains non-numeric character"
        	});
            return;
        }
        ...
        try {
            ...
            console.warn(e);
        	WRPCommon.MsgBoxModule.alert({
        		message: "WholeSale Price contains non-numeric character"
        	});
            return;
        }
    ...
    editAccessoryItemDictPop: function(event) {
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                $("#accessory-item-save-btn").css("visibility", "visible");
                $('#accessory-edit-window').jqxWindow({title: "Edit Accessory Item"});
    ...
    initAccessoryItemDictInfo: function() {
        ...
        $("#accessory-item-save-btn").css("visibility", "visible");
        $('#accessory-edit-window').jqxWindow({title: "Add Accessory Item"});
        $('#accessory-edit-window').jqxWindow('open'); 
    ...
    saveAccessoryItem: function() {
        ...
        try {
            ...
            console.warn(e);
        	WRPCommon.MsgBoxModule.alert({
        		message: "Qty contains non-numeric character"
        	});
            return;
        }
    ...
    getServiceItemDictList: function() {
    	var param;
        param={};
        ...
        try {
            param.keyword = document.getElementById("inven-service-item-search-keyword").value;
        } catch (e) {
        	console.warn(e);
        	return;
        }
        try {
        	param.category = parseInt(document.getElementById("inventory-service-item-category").value);
        	if (isNaN(param.category)) {
        		param.category = 0;
        	}
        } catch (e) {
        ...
        try {
        	param.subCategory = parseInt(document.getElementById("inventory-service-item-category-sub").value);
        	if (isNaN(param.subCategory)) {
        		param.subCategory = 0;
        	}
        } catch (e) {
        ...
        $.ajax({
            ...
            success: function(result) {
            	var data, elem, i, len, obj;
            	elem = $("#jqx-inventory-items-service-item-list");
    			data = result.data;
    			elem.jqxGrid("clear");
    			if (!data) return;
    ...
    informServiceItemDictInfo: function(event) {
        var storeId, i, len, elem, list, rowdata;
        ...
        try {
            try {
                document.getElementById("service-item-item-code").value = (rowdata.item_code !== undefined && rowdata.item_code !== null)? rowdata.item_code : "";
            } catch (e) {
                console.log(e);
            }
            try {
                document.getElementById("service-item-model").value = (rowdata.model !== undefined && rowdata.model !== null)? rowdata.model : "";
            } catch (e) {
                console.log(e);
            }
            try {
                document.getElementById("service-item-description").value = (rowdata.description !== undefined && rowdata.description !== null)? rowdata.description : "";
            } catch (e) {
                console.log(e);
            }
            try {
                document.getElementById("service-item-distributor").value = (rowdata.distributor !== undefined && rowdata.distributor !== null)? rowdata.distributor : "";
            } catch (e) {
                console.log(e);
            }
            try {
                document.getElementById("service-item-manufacturer").value = (rowdata.manufacturer !== undefined && rowdata.manufacturer !== null)? rowdata.manufacturer : "";
            } catch (e) {
                console.log(e);
            }
            try { 
                document.getElementById("service-item-category").value = (rowdata.category !== undefined && rowdata.category !== null)? rowdata.category : "";
            } catch (e) {
                console.log(e);
            }
            ...
            try { 
                document.getElementById("service-item-sub-category").value = (rowdata.sub_category !== undefined && rowdata.sub_category !== null)? rowdata.sub_category : "";
            } catch (e) {
                console.log(e);
            }

            try {
                document.getElementById("service-item-color").value = (rowdata.color !== undefined && rowdata.color !== null)? rowdata.color : "";
            } catch (e) {
                console.log(e);
            }

            try {
                document.getElementById("service-item-condition").value = (rowdata.condition !== undefined && rowdata.condition !== null)? rowdata.condition : "";
            } catch (e) {
                console.log(e);
            }
            try {
                document.getElementById("service-item-sku").value = (rowdata.sku !== undefined && rowdata.sku !== null)? rowdata.sku : "";
            } catch (e) {
                console.log(e);
            }

            try {
                document.getElementById("service-item-item-type").value = (rowdata.item_type !== undefined && rowdata.item_type !== null)? rowdata.item_type : 0;
            } catch (e) {
                console.log(e);
            }

            try {
                document.getElementById("service-item-qty").value = (rowdata.qty !== undefined && rowdata.qty !== null)? rowdata.qty : "";
            } catch (e) {
                console.log(e);
            }

            try {
                document.getElementById("service-item-wholesale-price").value = (rowdata.retail_price !== undefined && rowdata.retail_price !== null)? "$"+rowdata.retail_price.toFixed(2) : "$0.00";
            } catch (e) {
                console.log(e);
            }

            try {
                document.getElementById("service-item-retail-price").value = (rowdata.wholesale_price !== undefined && rowdata.wholesale_price !== null)? "$"+rowdata.wholesale_price.toFixed(2) : "$0.00";
            } catch (e) {
                console.log(e);
            }

            try {
                document.getElementById("service-item-item-cost").value = (rowdata.item_cost !== undefined && rowdata.item_cost !== null)? "$"+rowdata.item_cost.toFixed(2) : "$0.00";
            } catch (e) {
                console.log(e);
            }
        } catch (e) {
    ...
    getFeeList: function() {
        ...
        try {
            keyword = document.getElementById("inven-fee-search-keyword").value;
        } catch (e) {
        	console.warn(e);
        	return;
        }
        ...
        $.ajax({
            ...
            success: function(result) {
            	...
            	elem = $("#jqx-inventory-items-fee-list");
            	elem.jqxGrid("clear");
    ...
    informFeeInfo: function(event) {
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                try {
                    document.getElementById("fee-type").value = (data.feeType !== undefined && data.feeType !== null)? data.feeType: '';
                } catch (e) {
                    console.warn(e);
                    return;
                }
                ...
                try {
                    document.getElementById("fee-name").value = (data.name !== undefined && data.name !== null)? data.name: "";
                } catch (e) {
                    console.warn(e);
                    return;
                }
                ...
                try {
                    document.getElementById("fee-description").value = (data.description !== undefined && data.description !== null)? data.description: "";
                } catch (e) {
                    console.warn(e);
                    return;
                }
                ...
                try {
                    document.getElementById("fee-amount").value = (data.amount !== undefined && data.amount !== null)? "$"+ data.amount.toFixed(2): "$0.00";
                } catch (e) {
                    console.warn(e);
                    return;
                }
    ...
    setFeeInfo: function() {
        ...
        try {
            ...
            if (isNaN(data.amount)) {
            	WRPCommon.MsgBoxModule.alert({
            		message: "Amount contains non-numeric characters"
            	});
                return;
            }
        } catch (e) {
    ...
    getReturnedItemsList: function() {
        var storeId, start_date, end_date, invoice_no;
        ...
        invoice_no = document.getElementById("inventory-return-search-keyword").value;
        try {
      		document.getElementById("loading-container").style.display = "block";
      	} catch (e) {
    		console.warn(e);
            	...
            	if(elem){
            		for(i = 0; i < data.length; i++){
            			if(data[i].taxRate !== undefined && data[i].taxRate > 0){
            				data[i].taxAmnt = ((data[i].price * data[i].taxRate));
    ...
    /*BIN END (BANGWOORI) */
    getSalesHistoryBySerialItem: function() {
        var storeId, i, len, elem, list, itemSid, start_date, end_date;
        ...
        try {
        	start_date = $("#serialized-item-search-start-date").val();
        	end_date = $("#serialized-item-search-end-date").val();
        } catch (e) {
            console.warn(e);
            return;
        }
    ...
    getSalesHistoryByAccessory: function() {
        var storeId, itemSid, start_date, end_date;
        ...
        try {
        	start_date = $("#accessory-sales-search-start-date").val();
        	end_date = $("#accessory-sales-search-end-date").val();
        } catch (e) {
            console.warn(e);
            return;
        }
    ...
    getSalesHistoryByService: function(feeSid) {
        ...
        try {
        	start_date = $("#service-sales-search-start-date").val();
        	end_date = $("#service-sales-search-end-date").val();
        } catch (e) {
            console.warn(e);
            return;
        }
    ...
    printInvoiceItems: function() {
    	...
    	for (i = 0, len = list.length; i < len; i++) {
    		...
    		if (obj.sub_total === undefined) {
        		tmp = ((obj.price - obj.discount + obj.tax_amnt) * obj.qty);
        		if (obj.item_type === 3) {
        			if (obj.fee_amnt !== undefined) {
        				tmp = tmp + obj.fee_amnt;
        			}
        		}
    			obj.sub_total = tmp;
    		}
    		total_price = total_price + obj.sub_total;    		
    	}
    	...
    	if (obj) {
    		obj.jqxDataTable({
				...
				columns: [
					...
					{ text: "Sub Total", width: 80, datafield: "sub_total", cellsformat: "c2", editable: false, autoCellHeight: false },
	...
	checkItemCodeDuplicate: function(input_elem_id) {
		var input, store_id;
        ...
        input = document.getElementById(input_elem_id);
        if (!input) {
        	return;
        }
        	...
        	success: function(result) {
        		...
        		if (!data) {
                	WRPCommon.MsgBoxModule.alert({
                		message: "OK.",
                		okBtnClick: function(){
                			if(input_elem_id.indexOf("serialized") == 0) {
                    			try { $("#serialized-item-save-btn").css("visibility", "visible"); } catch (e) {}
                			} else if(input_elem_id.indexOf("accessory") == 0) {
                    			try { $("#accessory-item-save-btn").css("visibility", "visible"); } catch (e) {}
                			}
                		}
                	});
        			return;
        		...
        		if (data.sid === undefined) {
                	...
                	WRPCommon.MsgBoxModule.alert({
                		...
                		okBtnClick: function(){
                			if(input_elem_id.indexOf("serialized") == 0) {
                    			//try { $("#serialized-item-save-btn").css("visibility", "hidden"); } catch (e) {}
                			} else if(input_elem_id.indexOf("accessory") == 0) {
                    			//try { $("#accessory-item-save-btn").css("visibility", "hidden"); } catch (e) {}
                			}
                		}
                	});
        		}
