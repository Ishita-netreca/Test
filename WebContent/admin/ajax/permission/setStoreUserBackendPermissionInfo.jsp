...
<%
        ...
        try {
            ...
            if (isUpdate) {
                ...
                stmt.execute(String.format("INSERT INTO `%s`.`tb_user_permission_%s`(`user_id`,`backend_permission`) VALUES('%s','%s'); UPDATE `wrp`.`tb_user` SET `group_permission_flag`='0' WHERE `user_id`='%s';", db_name, storeId, userId, permissionInfoString, userId));
            }
