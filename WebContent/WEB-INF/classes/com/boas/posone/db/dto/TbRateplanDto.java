...
public class TbRateplanDto{
    ...
    public TbRateplanDto() { }
    public TbRateplanDto(int sid, String rateplanCode, String carrier, String description, int planTypeId, int groupTypeId, float mrc, int reactPlanFlag, Date startDate, Date endDate, int updater, Date updateDate, int disable) {
        this.sid = sid;
