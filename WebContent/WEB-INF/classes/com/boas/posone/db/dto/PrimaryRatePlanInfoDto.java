...
public class PrimaryRatePlanInfoDto {
	private int no;
	...
	public PrimaryRatePlanInfoDto() {
		
	}
	
	public PrimaryRatePlanInfoDto(int no, String planCode, String planDescription, String planType, float mrc) {
		this.no = no;
