...
public class ClockIoInfoUserVo {
	...
	public ClockIoInfoUserVo() {
		
	}
	
	public ClockIoInfoUserVo(int clockIoNo, int userNo, int storeNo, String clockInIp, String clockInDate, String clockInMemo, String clockOutIp, String clockOutDate, String clockOutMemo, String userName, String userId) {
	...
	public String toJsonString() {
		...
		if (this.remoteIp != null) {
			sb.append(String.format("\"remoteIp\":\"%s\",", this.remoteIp));
		}
